...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'anonim/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'anonim.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'anonim/static')
]
